...
plt.plot(snr, df_cafe, color='r', marker='x', label='Dialogflow (Cafe)')
plt.plot(snr, df_kitchen, color='r', linestyle='--', marker='o', label='Dialogflow (Kitchen)')
plt.plot(snr, pv_cafe, color='b', marker='x', label='Picovoice (Cafe)')
