...
if __name__ == "__main__":
    ...
    parser.add_argument('--engine_type', choices=['AMAZON_LEX', 'GOOGLE_DIALOGFLOW', 'PICOVOICE_RHINO'],
                        required=True)
    ...
    engine = NLUEngine.create(NLUEngines[args.engine_type], args.gcp_project_id)
